...
if (choice == 1)
{
   ...
   cout << "but one day you find a note from Dr. Brown asking you to take out his car for a wash" << endl;
   cout << "and an \"italian\" tune up." << endl;
   cout << "\"Cool!\" you think, \"These lab fumes are giving me a headache and" << endl;
   cout << "Dr. Brown drives a badass car!\"" << endl;
   cout << "You grab the keys off the counter and head out to the car." << endl;
   EnterToContinue();
   cout << "You hop in the car and put on your seat belt." << endl;
   ...
   cout << "           `\\<<<<</'                            `\\>>>>>/'  " << endl;
   cout << endl;
   cout << "\"The car wash can wait,\" you exclaim to yourself, \"It's time for an italian tune up!\"" << endl;
   EnterToContinue();    
   ...
   cout << "Suddenly, Dr. Brown's voice comes on over the car speakers: \"Hello " << user << ", I hope you're enjoying the tune up!\"" << endl;
  ...
  cout << "\"Let's see what you got for me, " << user << "\" he says." << endl;
